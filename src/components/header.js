...
class HeaderComponent extends Component{
  constructor(props){
    ...
    this.state = {isCurrencyDropdown: false, show: false}
        ...
        <Actions>
          <CurrencySwitch>
              <CurrencyContainer>
                ...
                { 
                 this.state.isCurrencyDropdown && <Backdrop onClick={() => this.setState({isCurrencyDropdown: false})}><DropDown>
          ...
          <Cart>
              <svg onClick={() => this.setState(prevState => ({show: !prevState.show}))} style={{position:'absolute',right:'10px'}} width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             {this.state.show && <CartModal close={() => this.setState({show: false})} /> }
