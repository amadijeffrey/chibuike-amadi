...
class HeaderComponent extends Component{
  constructor(props){
    ...
    this.currencySwitcher = React.createRef();
        ...
        <Actions>
          <CurrencySwitch>
              <CurrencyContainer>
                ...
                { 
                 this.state.isCurrencyDropdown && <DropDown ref={this.currencySwitcher}>
          ...
          <Cart>
          <svg style={{position:'absolute',right:'10px'}} width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
 ...
 function displayNoOfCartItem(cartArray){
  let number = 0
